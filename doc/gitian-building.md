...
in the zoin repository under 'Fetch and create inputs' to install sources which require
...
To build Zoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
